...
onready var viewport_selected_item = $outerMargin/innerVbox/ContentMargin/SeparateMargin/Body/ScrollContainer/ItemList/Item1/inner/Content/Image/Panel/Viewport
